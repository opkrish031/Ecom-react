      ...
      <div className="mx-auto container px-4 md:px-6 2xl:px-0 py-12">
        <div className="flex flex-col items-start">
          ...
          <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-8">
            {wishlist.map((item) => (
              <div className="bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden" key={item.id}>
                <div className="relative">
                  <img className="w-full h-60 object-cover" src={item.thumbnail} alt={item.title} />
                  <button
                ...
                <div className="p-6">
                  <h2 className="text-xl font-semibold text-black dark:text-black truncate">{item.title}</h2>
                  <p className="text-sm text-black dark:text-gray-400 mt-1">Category: {item.category}</p>
                  <p className="text-sm text-black dark:text-gray-400 mt-1">ID: {item.id}</p>
                  <p className="text-lg font-medium text-black  mt-3">${item.price}</p>
                  <p className="text-sm text-black dark:text-gray-400 mt-2">{item.warrantyInformation}</p>
