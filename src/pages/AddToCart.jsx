          ...
          <div className="flex shadow-md my-10">
            <div className="w-3/4 bg-white px-10 py-10">
              ...
              {cart.length === 0 ? (
                ...
                cart.map((v) => (
                  <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5" key={v.id}>
                    <div className="flex w-2/5">
                      ...
                      <div className="flex flex-col justify-between ml-4 flex-grow">
                        ...
                        <button className="font-semibold hover:text-red-500 text-gray-500 text-xs" onClick={() => removeFromCart(v.id)}>
                          Remove
                        </button>
                      </div>
                    </div>
                    ...
                    <span className="text-center w-1/5 font-semibold text-sm">${(v.quantity * v.price).toFixed(2)}</span>
                  </div>
                ))
              )}
            ...
            <div id="summary" className="w-1/4 px-8 py-10">
              ...
              <div className="py-10">
                ...
                <input type="text" className="p-2 text-sm w-full" placeholder="Enter your code" />
              </div>
